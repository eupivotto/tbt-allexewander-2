      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4 text-xs">
          <span className="flex items-center gap-1.5">
            <span className="table-available w-3 h-3 rounded border-2 border-white/30 inline-block" />
            <span className="text-gray-400">✦ Mesas com brilho pulsante estão disponíveis</span>
          </span>
          <span className="flex items-center gap-1.5">
