  ...
  const renderTable = (num: number, extraClass = "") => {
    ...
    return (
      <button
        ...
        className={`relative flex items-center justify-center w-12 h-12 rounded-lg border-2 font-bold text-sm transition-all ${bgClass} ${extraClass}`}
      >
    ...
    <div className="w-full max-w-5xl mx-auto overflow-x-auto p-4">
      <div className="min-w-[860px] bg-black/40 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
        ...
        <div className="flex gap-4">
          ...
          {/* ── LEFT: ÁREA CHOPERIA (mesas 25–32) ── */}
          ...
          {/* ── RIGHT: Grid principal (mesas 01–24) ── */}
          <div className="flex-1 flex flex-col gap-2">

            {/* Linha 1: headers + mesas 01-03 + 04-08 — mesma coluna */}
            <div className="flex items-end gap-2">

              {/* Coluna A: BAR header + mesas 01–03 */}
              ...
              {/* Coluna B: PALCO header + mesas 04–08 (PREMIUM) */}
              <div className="flex flex-col gap-1">
              ...
              {/* Coluna C: BAR INDIVIDUAL (só header) */}
            ...
            {/* Linha 2: 09–11 (col A) + 12–16 (col B) */}
            <div className="flex items-start gap-2">
              {/* Coluna A: mesas 09–11 */}
              <div className="flex gap-2">
                {[9, 10, 11].map(n => renderTable(n))}
              </div>

              {/* Separador visual alinhado */}
              <div className="w-px self-stretch bg-white/20 mx-1" />

              {/* Coluna B: mesas 12–16 */}
              <div className="flex gap-2">
            ...
            {/* Linha 3: 17–19 (col A) + 20–24 (col B) */}
            <div className="flex items-start gap-2">
              {/* Coluna A: mesas 17–19 */}
              <div className="flex gap-2">
